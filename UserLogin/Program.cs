...
namespace UserLogin
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var loginValidation = new LoginValidation(usernameI, passwordI, Console.WriteLine);
            if (!loginValidation.ValidateUserInput(out var blankUser)) return;
            switch (blankUser.UserRole)
            {
                case 1:
            ...
            Console.WriteLine(blankUser.Username);
            Console.WriteLine(blankUser.Password);
            Console.WriteLine(blankUser.FacNumber);
        }
    }
}